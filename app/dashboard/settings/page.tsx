    ...
    <div className="max-w-2xl">
      ...
      <section className="card-panel mt-8 overflow-hidden">
        {rows.map((row) => (
          <div
            key={row.label}
            className="flex items-center justify-between border-b border-black/5 px-5 py-4 last:border-0"
          >
      ...
      <section className="card-panel mt-6 p-6">
        <h2 className="font-semibold text-zinc-900">Password & security</h2>
        ...
        <Link
          ...
          className="mt-4 inline-block rounded-full border border-zinc-300 px-5 py-2.5 text-sm text-zinc-700 hover:border-zinc-400"
        >
          Manage account
        </Link>
      </section>
      ...
      <section className="card-panel mt-6 flex items-center justify-between p-6">
        <div>
          <h2 className="font-semibold text-zinc-900">Sign out</h2>
        ...
        <SignOutButton redirectUrl="/">
          <button
            type="button"
            className="rounded-full border border-red-300 px-5 py-2.5 text-sm text-red-600 transition-colors hover:border-red-500"
          >
            Sign out
          </button>
        </SignOutButton>
